...
Data for this demo is obtained from the following data source: [Global Temperature - Earth Indicator - NASA Science](https://science.nasa.gov/earth/explore/earth-indicators/global-temperature/).

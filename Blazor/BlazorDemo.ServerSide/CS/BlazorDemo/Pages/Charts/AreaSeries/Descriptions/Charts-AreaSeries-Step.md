Step area series display data as regions between the argument axis and series values joined by horizontal and vertical line segments (forming a step-like pattern). Follow the steps below to create a step area series:
...
2. Add a [DxChartStepAreaSeries](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChartStepAreaSeries-3) object to chart markup.

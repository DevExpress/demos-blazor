Spline series display data as points connected by smooth curves. Follow the steps below to create a spline series:
...
2. Add a [DxChartSplineSeries](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChartSplineSeries-3) object to chart markup.

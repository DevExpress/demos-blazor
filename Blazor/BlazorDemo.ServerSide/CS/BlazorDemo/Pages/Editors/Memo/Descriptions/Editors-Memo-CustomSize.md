...
You can use the [SizeMode](https://docs.devexpress.com/Blazor/DevExpress.Blazor.Base.DxEditorComponentBase.SizeMode) property to specify a predefined size mode: Large, Medium, or Small. This property sets text and **Clear** button size.

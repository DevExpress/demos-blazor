...
public class Startup {
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddKeyedScoped<IChatResponseProvider>(ChatClientKeys.WorkflowResponseStreaming, (provider, key) => {
            ...
            return new WorkflowResponseProvider<string>(
                agentFactory.CreateShakespeareanPoetWorkflow(agentWorkflowClient),
                GetLastUserText);
        });
